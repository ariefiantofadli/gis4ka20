...
<div class="page-header">
  <h1>Home</h1>
					...
					<div style="text-align: center;">
						<h2>Daftar Indomaret, Alfamart, dan Alfamidi, Jalan Komjen Pol. M Jasin - Jalan Raya Margonda, Depok</h2>
						<h4>Dari Kampus G - Kampus D, Universitas Gunadarma</h4>
					</div>
					<p>Tugas Kelompok Sistem Informasi Geografis</p>
