	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url() ?>">my GIS</a>
			</div>
                ...
                <ul class="nav navbar-button navbar-nav navbar-right">
                    <li>
                        ...
                        <a data-toggle="modal" href='#modalLogin' class="hvr-rotate" title="Lgoin">
                            <i class="fa 2fa-sign-in"></i> Login
                        </a>
                    	<?php else : ?>
                    	...
                    	<?php endif; ?> 
						<a data-toggle="modal" href='<?php echo base_url('admin') ?>' class="hvr-rotate">
                            <i class="fa fa-sign-in"></i> Admin
                        </a> -->
                    </li>
                </ul>
				<ul class="nav navbar-nav navbar-right">
					<li><a href="<?php echo base_url('admin') ?>" class="hvr-underline-reveal">Admin</a></li>
	...
	<footer class="page-break-top">
		...
		<div class="container">
			<div class="row">
				...
				<div class="hr5"></div>
				<div class="col-md-12">
					<p class="text-center">Copyright &copy; 2018 <a href="http://fadliariefianto.com" target="_blank">Fadhlillah Ariefianto</a>. All Right Reserved</small></p>
				</div>
			</div>
		</div>
	</footer>
